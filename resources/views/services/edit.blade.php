            ...
            <div class="card-body register-card-body">
                ...
                <form action="{{ route('services.update',$service->id) }}" method="POST">
                    ...
                    <div class="input-group mb-3">
                        <input type="text" name="name" class="form-control" placeholder="Name" value="{{$service->name}}" required autofocus>
                    ...
                    <div class="input-group mb-3">
                        <input class="form-control" placeholder="Price" type="number" name="price" id="price"  value="{{$service->price}}" required>
                        <div class="input-group-append">
                            <div class="input-group-text">
